...
class Client
{
     ...
     public static function getProductsSkusCount($id)
   {
    ...
    public static function getCustomerAddress($id,$addressid)
    {
        return self::getResource('/customers/' . $id . '/addresses/'.$addressid);
    }

    public static function updateCustomerAddress($id,$addressid, $object)
    {
        return self::updateResource('/customers/' . $id . '/addresses/' . $addressid, $object);
    }

    public static function deleteACustomerAddress($id,$addressid)
    {
        return self::deleteResource('/customers/' . $id . '/addresses/' . $addressid);
    }
    /**
	...
	public static function getproductoption($id)
	{
		 return self::getCollection('/products/' . $id . '/options');
	}

    public static function getproductvariants($id)
    {
         return self::getCollection('/products/' . $id . '/variants');
    }
    ...
    public static function createcustomergroup($object)
    {
      ...
      public static function getCustomerGroupone($id)
    {
        return self::getResource('/customer_groups/'.$id);
    }
