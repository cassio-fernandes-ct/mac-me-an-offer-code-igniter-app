			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper" >
						<a href="<?php  echo $this->config->base_url(); ?>admin/Test_Quote" class="btn btn-brand btn-icon-sm">
									...
									<div class="kt-widget12">
										<div class="kt-widget12__content">
											<div class="kt-widget12__item" style="margin-bottom: 0;">	
												...
												<?php
												@$exp_offeredprice = explode("$", @$getquotedetails['customerinfo']['offered_price']);
											...
											<?php } ?>
												...
												<div class="kt-portlet__head-toolbar">
													<div class="kt-portlet__head-wrapper">
														<a href="<?php  echo $this->config->base_url(); ?>admin/Test_Quote/emailsend/<?php echo $getquotedetails['customerinfo']['id']?>" class="btn btn-brand btn-icon-sm">
	...
	function saveOfferPrice(){
		...
		if(offered_price != '' &&offered_price != undefined && offered_price > 0){
			$.ajax({
					...
					url: '<?php echo base_url(); ?>admin/Test_Quote/saveOfferPrice',
					type: 'post',
