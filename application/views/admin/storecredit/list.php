	...
	<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__body">
				...
				<div class="alert-text">Serise inserted successfully.</div>
				...
				<div class="alert alert-solid-success alert-bold" role="alert">
				<div class="alert-text">Store credit updated successfully.</div>
				<div class="alert-close">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
				<span aria-hidden="true"><i class="la la-close"></i></span>
				</button>
				...
				<?php $deleted 	= $this->session->userdata('notabletoredirect'); 
				if(isset($deleted) && !empty($deleted)){ ?>
					<div class="alert alert-solid-danger alert-bold" role="alert">
						<div class="alert-text">You can't able to edit Store Credit because of Mac Me An Offer ID or Mac Of All Trades ID is missing. </div>
						<div class="alert-close">
							<button type="button" class="close" data-dismiss="alert" aria-label="Close">
								<span aria-hidden="true"><i class="la la-close"></i></span>
							</button>
				...
				<?php $this->session->unset_userdata('notabletoredirect'); } ?>
...
<script src="<?php echo $this->config->base_url();?>assets/js/pages/crud/metronic-datatable/base/storecredit_data-ajax.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	{
		window.location="<?php echo base_url(); ?>admin/sto/update/"+categoryid+"/"+status;
	}
	function ask_confirmation_for_delete_serise(serise_id,title)
	{

		swal.fire({
			title:"are you sure you want to delete the serise \""+title+"\" ?",
			text:"You won't be able to revert this!",
			type:"warning",
			showCancelButton:!0,
			confirmButtonText:"Yes, delete it!"
		}).then(function(e){
			e.value&&swal.fire("Deleted!","Your serise has been deleted.","success");
			if(e.value)
			{
	...
	function update_storescredit(mmo,mmt)
	{
		window.location=base_url+'admin/Storecredit/edit/'+mmo+'/'+mmt;
	}
